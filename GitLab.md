...
|---|---|---|---|---|
| QA-01 | Инициализация Git репозитория | Репозиторий успешно инициализируется | Репозиторий успешно создан | ✅ |
| QA-02 | Push кода в GitLab | Код успешно загружается в удаленный репозиторий | Push выполнен успешно | ✅ |
| QA-03 | Автоматический запуск pipeline | Pipeline автоматически запускается после push | Pipeline успешно запустился | ✅ |
| QA-04 | Сборка Docker образа | Docker образ успешно собирается | Сборка выполнена успешно | ✅ |
| QA-05 | Деплой в Kubernetes | Приложение успешно деплоится в кластер | Deployment выполнен успешно | ✅ |
| QA-06 | Доступность веб-сайта | Сайт открывается в браузере | Сайт успешно доступен по URL | ✅ |
| QA-07 | Отображение CSS | Стили отображаются корректно | CSS отображается корректно | ✅ |
| QA-08 | Автоматический redeploy | После нового push приложение автоматически обновляется | Redeploy выполнен успешно | ✅ |
...
<img src="screenshots/GitLab/gitlab_pipeline.png" width="700">
- Успешно задеплоенный веб-сайт
<img src="screenshots/GitLab/deployed_website.png" width="700">
- Автоматическое обновление сайта после нового commit
<img src="screenshots/GitLab/code_changes.png" width="700">
<img src="screenshots/GitLab/deployed_changes.png" width="700">
